...
I've tested a bit with the parameters of the HOG features. An example using the final paramaters is shown below (It's color is adjusted to get a clearere picture).
